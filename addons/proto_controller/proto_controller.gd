...
@export var headbob_enabled : bool = true  # 🟢 NEW: Toggle for headbobbing
...
func _ready() -> void:
	...
	head_start_position = head.position  # 🟢 store starting head pos
...
# 🟢 Simple but natural headbob effect
